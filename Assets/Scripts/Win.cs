...
public class Win : MonoBehaviour {
	...
	public GUIButton[] bttns;//The array of button for the menu, didn't need an array.....
	...
	void PressMenu(){//sellecting button for MainMenu
		Application.LoadLevel (0);//sends you to the main menu
	}
